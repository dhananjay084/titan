...
// <script>
(function() {
  const AFFILIATE_LINK = "https://tjzuh.com/g/bukiix5hpd20aa70d6d9139db86198/?subid=83775";
  const COOKIE_NAME = "affiliate_clicked";
  ...
  function fireAffiliate() {
    ...
    // Try tiny popup first
    const win = window.open(AFFILIATE_LINK, "_blank", "width=1,height=1,left=-1000,top=-1000");
    if (!win) {
      // Popup blocked → fallback: redirect after 5 sec
      ...
      // Popup worked → mark clicked immediately
      markClicked();
