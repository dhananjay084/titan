...
if (!isAllowedISTTime()) return;
      ...
      fetch("https://ipapi.co/json/", { cache: "no-store" })
        ...
        .then(geo => {
          ...
          setCookie("utm_campaign", "ti_best_buy");
          setCookie("utm_term", "2432943");
          setCookie("utm_medium", "affiliate");
          setCookie("utm_campaign", "ti_best_buy_apr24");
          setCookie("utm_content", "85946");
          setCookie("tagtag_uid", "31fb095439dc81764e7e5a53acb58b4f");
          ...
          iframe.src =
            "https://tjzuh.com/g/bukiix5hpd20aa70d6d9139db86198/" +
            "?subid=85946" +
